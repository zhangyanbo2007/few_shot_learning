...
def online_predict():
    ...
    with tf.Session(config=sess_config) as sess:
        ...
        checkpoint_prefix = os.path.join(save_path, config["model_name"] + "-30000")
        model.saver.restore(sess, checkpoint_prefix)
        # pos_sentence = ["i like it", "i love it", "i get it make me so happy", "happy", "so love it", "amazing"]
        # neu_sentence = ["hello world", "hello python", "what is it", "are you ok", "hello c++", "hello everyone"]
        # neg_sentence = ["it's do bad", "rubbish", "i don't like it", "i don't love it", "shit", "bullshit"]
        pos_sentence = ["i want to go to sleep", "i want to go to bed", "i'm so sleepy", "i'm so tired", "go to bed", "please,I'm sleepy"]
        neg_sentence = ["let's play a game", "let's go", "just do it", "go go go", "we play a game", "we move"]
        pos_ids = []
